...
const Signin = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      alert(`Currently website in under development, so you can not login.`);
  ...
  return (
    <div className="h-screen bg-white flex items-center justify-center">
      <div className="w-full xl:mx-auto max-w-8xl flex h-full shadow-xl overflow-hidden">
        ...
        <div className="w-full lg:w-2/5 bg-gradient-to-br from-purple-600 via-violet-700 to-indigo-800 flex items-center justify-center p-10">
          <div className="w-full max-w-sm space-y-4 bg-white/10 p-8 rounded-xl text-center">
            ...
            <p className="text-gray-100">
              ...
              <Link to="/signup" className="text-violet-100 font-semibold hover:underline">
              Sign Up
              </Link>
            </p>
          </div>
